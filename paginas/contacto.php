...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="contacto.css"></li>
</head>
<body>
...
<div class="row">
   ...
   <div class="templatemo_contacttitle">CONTACTO</div>
    <div class="templatemo_sub_contacttitle">Directo con Mascotaland.</p>
   ...
   <form action="enviar.php" method="post">
                        ...
                        <input type="text" name="phone" id="subject" class="subject" placeholder="TELEFONO">
